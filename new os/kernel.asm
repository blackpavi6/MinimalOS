...
[SEGMENT .data]
    strWelcomeMsg   db  "Welcome to JackOS... Thanks for using this operating system.", 0x00
	strPrompt		db	"JackOS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"JackOS - edited by PAVI", 0x00	;OS details
